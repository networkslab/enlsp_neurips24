...
class AdalasOPTDecoderLayer(OPTDecoderLayer):
    ...
    def forward(
            ...
            propagate_kv_cache_only: Optional[bool] = False
        ...
        hidden_states, self_attn_weights, present_key_value = self.self_attn(
            ...
            propagate_kv_cache_only=propagate_kv_cache_only
        )
        if propagate_kv_cache_only:
...
class AdalasOPTAttention(OPTAttention):
    def __init__(self,
                 embed_dim: int,
                 num_heads: int,
                 dropout: float = 0.0,
